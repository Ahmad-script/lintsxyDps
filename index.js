...
//
const BotName = 'lintsxyDps'; // Nama Bot Whatsapp
const instagramlu = 'gk ada'; // Nama Instagramlu cok
const whatsapplu = '+62 858-6502-3689'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by lintsxyDps`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by lintsxyDps`)
})
